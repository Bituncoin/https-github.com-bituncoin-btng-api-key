...
public class BTNGWalletService
{
    ...
    public object Mint(string wallet, decimal amount)
    {
    ...
    public object Melt(string wallet, decimal amount)
    {
        if (string.IsNullOrWhiteSpace(wallet))
            throw new ArgumentException("Wallet address is required", nameof(wallet));
        if (amount <= 0)
    ...
    public object GetBalanceSummary()
    {
        return new
        {
    ...
    public object AddAddress(string chain, string type, string label, string addressOrXpub)
    {
        return new
        {
    ...
    public object ImportFromBlockchair()
    {
        return new
        {
